...
import com.example.registrobkb.DataBase.Viewmodels.ScoreViewModel
import kotlinx.android.synthetic.main.contadores_equipos.*
...
class Activity_three : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.contadores_equipos)
